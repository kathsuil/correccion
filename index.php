...
<!-- imagen -->
                      <a href="single.php?url=<?php print($a)?>">
                          <img src="<?php echo $csv[$a]["images"];?>" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                      </a>
<!-- bajada -->
                <p><?php echo $csv[$a]['resumen'];?></p>
                <a class="btn btn-default read-more" href="single.php?url=<?php print($a)?>">Leer más <span class="glyphicon glyphicon-chevron-right"></span></a>
<hr>
        </div>
